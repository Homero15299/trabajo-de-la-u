...
<body>
    ...
    @if(session('success'))
        <div style="background-color: #4CAF50; color: white; padding: 10px; margin-bottom: 15px; text-align: center;">
            {{ session('success') }}
        </div>
    @endif

    <form method="POST" action="{{ route('profesores.update', $profesor->id) }}" role="form">
        @csrf
        @method('PUT')
        ...
        <input type="number" id="edad" name="edad" value="{{ old('edad', $profesor->edad) }}" 
        ...
        <input type="text" id="tipo_sangre" name="tipo_sangre" value="{{ old('tipo_sangre', $profesor->tipo_sangre) }}" 
        ...
        <input type="number" id="numero_id" name="numero_id" value="{{ old('numero_id', $profesor->numero_id) }}" 
        ...
        <input type="text" id="tipo_id" name="tipo_id" value="{{ old('tipo_id', $profesor->tipo_id) }}" 
        ...
        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $profesor->fecha_nacimiento) }}" 
        ...
        <input type="text" id="programa" name="programa" value="{{ old('programa', $profesor->programa) }}" 
